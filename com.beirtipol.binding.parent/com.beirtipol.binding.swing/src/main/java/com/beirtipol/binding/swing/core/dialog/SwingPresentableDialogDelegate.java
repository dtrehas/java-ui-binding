...
public class SwingPresentableDialogDelegate<P extends IPresenter> extends SwingDialogDelegate implements IPresentableDialogDelegate<P> {
	private final AbstractPresentableSwingPanel<P> child;

	public SwingPresentableDialogDelegate(JDialog dialog, AbstractPresentableSwingPanel<P> child) {
		super(dialog);
		this.child = child;
	}
