/*
 * Copyright 2007 Sun Microsystems, Inc. All Rights Reserved. DO NOT ALTER OR REMOVE COPYRIGHT
 ...
 * <p>
 * Each <tt>IdentityArrayList</tt> instance has a <i>capacity</i>. The capacity
 * is the size of the array used to store the elements in the list. It is always
 * at least as large as the list size. As elements are added to an
 * IdentityArrayList, its capacity grows automatically. The details of the
 * growth policy are not specified beyond the fact that adding an element has
 * constant amortized time cost.
 * <p>
 * An application can increase the capacity of an <tt>IdentityArrayList</tt>
 ...
 * multiple threads access an <tt>IdentityArrayList</tt> instance concurrently,
...
public class IdentityArrayList<E> extends AbstractList<E> implements List<E>, RandomAccess {
	 ...
	 * stored. The capacity of the IdentityArrayList is the length of this array
	 * buffer.
	 */
	 ...
	 * <tt>(o==null&nbsp;?&nbsp;get(i)==null&nbsp;:&nbsp;o == get(i))</tt>, or
	 ...
	 * that <tt>(o==null&nbsp;?&nbsp;get(i)==null&nbsp;:&nbsp;o == get(i))</tt>
