...
public class MapEntryTreeNode extends BasicReflectionTreeNode {
	...
	public MapEntryTreeNode(ITreeNode parent, String name, Entry<?, ?> model,
	...
	public void createChildren(List<ITreeNode> children) {
		children.add(TreeNodeFactory.createTreeNode(this, "Key",
				model.getKey(), idContext));
		children.add(TreeNodeFactory.createTreeNode(this, "Value",
				model.getValue(), idContext));
	}
}