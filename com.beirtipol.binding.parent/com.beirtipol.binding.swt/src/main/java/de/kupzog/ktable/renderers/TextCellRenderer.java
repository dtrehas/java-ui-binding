 ...
 * content white.</li>
 * <li><b>INDICATION_COMMENT</b> makes the renderer draw a small triangle in the
 * upper right corner of the cell.</li>
...
public class TextCellRenderer extends DefaultCellRenderer {
	 ...
	 *            - INDICATION_FOCUS_ROW makes the cell show a selection
	 *            indicator as it is often seen in row selection mode. A deep
	 *            blue background and white content.<br>
	 *            - INDICATION_COMMENT lets the renderer paint a small triangle
	 *            to the right top corner of the cell.<br>
