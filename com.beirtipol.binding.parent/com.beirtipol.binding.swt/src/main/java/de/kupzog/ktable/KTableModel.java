 ...
 * <code>KTableDefaultModel</code> that handles the column width and row height
 * in the table. It also provides a framework for more advanced tablemodels, for
 * example <code>KTableSortedModel</code>. <br>
...
public interface KTableModel {
	 ...
	 * <code>null</code>, the table will use this method to set the changed cell
	 * values.
	 * 
	 * @param col
	 *            The column index.
	 ...
	 * cellrenderer from <code>KTableCellRenderer</code>. If it is some general,
	 * not too specific renderer, we would be happy to include it as a default
	 * renderer!
	 * 
	 * @param col
	 *            The column index
	 ...
	 * </code> In this case, the left upper cell (0,0) returns its own index and
	 * is responsible for the content of the whole spanned cell. The cells
	 ...
	 * large cell must always be a rectangle. Cells like <code>
	 *  ___________
	 * |   __|__|__| 
	 * |__|__|__|__|
	 ...
	 * number of fixed rows is the sum of header and selectable fixed rows.
	 * 
