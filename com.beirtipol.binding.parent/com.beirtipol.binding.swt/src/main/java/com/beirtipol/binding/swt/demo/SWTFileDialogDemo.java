...
public class SWTFileDialogDemo extends SWTAbstractPresentableComposite<Presenter> {
	...
	private SWTFileDialogDelegate fileChooserDelegate;

	public SWTFileDialogDemo(Composite parent, int style) {
		super(parent, style);
	}
	...
	public static void main(String[] args) {
		...
		SWTFileDialogDemo comp = new SWTFileDialogDemo(shell, SWT.NONE);
