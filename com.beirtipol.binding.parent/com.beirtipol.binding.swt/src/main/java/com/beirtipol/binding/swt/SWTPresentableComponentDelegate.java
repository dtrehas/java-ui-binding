...
public class SWTPresentableComponentDelegate<T extends IPresenter> extends
		SWTComponentDelegate implements IPresentableComponentDelegate<T> {
	private final SWTAbstractPresentableComposite<T> component;

	public SWTPresentableComponentDelegate(
			SWTAbstractPresentableComposite<T> component) {
		super(component);
