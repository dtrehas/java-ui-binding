...
public class SWTStyledTextDelegate implements ITextDelegate, ISWTDelegate {
	private StyledText text;
	private IBasicBinder<? extends IDelegate> basicBinder;
	boolean isMouseClicked = false;

	public SWTStyledTextDelegate(final StyledText text) {
		if (text == null) {
		...
		this.text.addDisposeListener(new DisposeListener() {
			...
			public void widgetDisposed(DisposeEvent e) {
				SWTStyledTextDelegate.this.text = null;
				if (basicBinder != null) {
