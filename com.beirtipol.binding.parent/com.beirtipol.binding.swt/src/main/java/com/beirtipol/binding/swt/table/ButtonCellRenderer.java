...
/**
 * Rather hacked together renderer to show a button in a table. This is mostly
 * copied from de.kupzog.ktable.renderers.CheckableCellRenderer so please see
 * the doc there for falgs etc.
 * 
 * @author v079057
 */
public class ButtonCellRenderer extends DefaultCellRenderer {
	/**
	...
	public final Image IMAGE_CHECKED;
	...
	public ButtonCellRenderer(boolean readOnly, Image checkedImagePath,
		...
		if (readOnly) {
			...
			IMAGE_CHECKED = checkedImagePath;
		}

		IMAGE_CHECKED_CLICKED = checkedClickedImage;

		m_alignment = SWTX.ALIGN_HORIZONTAL_CENTER | SWTX.ALIGN_VERTICAL_CENTER;
	}
